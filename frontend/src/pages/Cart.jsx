...
const Cart = () => {
  ...
  return (
    <>
      <div className="container flex justify-around items-start flex-wrap mx-auto mt-6">
        {cartItems.length === 0 ? (
          <div>
            Your cart is empty -
                ...
                >
                  ...
                  <div className="w-24">
                    <select
                      ...
                      value={item.qty}
                      onChange={(e) =>
                        addToCartHandler(item.qty, Number(e.target.value))
                      }
                    >
                  ...
                  <div>
                    <button
                      className="text-red-500 mr-[4rem]"
